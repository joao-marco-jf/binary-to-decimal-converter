...
export default function Header(){
    ...
    return(
        <header className="flex justify-between p-[1rem] md:px-[4rem] border-b-[1px] border-zinc-200">
            ...
            {isOpen &&
                <menu className={"absolute z-50 flex flex-col gap-[1rem] py-[1rem] px-[4rem] border-l-[1px] border-zinc-200 h-full w-[70%] md:w-[20%] bg-white top-0 right-0 md:text-lg"}>
