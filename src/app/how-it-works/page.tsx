export default function pageHowItWork(){
    return(
        <main className="flex flex-col p-[1rem] md:p-[5rem] lg:px-[10rem] xl:px-[20rem] 2xl:px-[30rem] gap-[2.8rem] text-zinc-400 text-md lg:text-lg">
            <h1 className="text-[1.6rem] md:text-[2rem] text-zinc-500 font-bold">Por qual intuito essa aplicação foi desenvolvida</h1>
            ...
            <h1 className="text-[1.6rem] md:text-[2rem] text-zinc-500 font-bold">Como é feita a conversão</h1>
